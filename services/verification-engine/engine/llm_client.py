...
async def call_llm(
    ...
    # When routing through a LiteLLM proxy, force OpenAI-compatible
    # routing so the model name (e.g. "zai/glm-5") is passed as-is
    # to the proxy without LiteLLM trying to parse the provider prefix.
    if api_base:
